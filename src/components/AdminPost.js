...
// import { AppBar, Box, Toolbar, Typography, Button, TextField, Container } from '@mui/material';
...
// const AdminPost = () => {
//   const [title, setTitle] = useState('');  // Updated field name
//   const [message, setMessage] = useState('');

//   const handlePost = async () => {
//     if (title && message) {  // Updated field name
//       try {
//         await axios.post('http://localhost:8080/api/posts', { title, message });  // Updated field name
//         setTitle('');
//         setMessage('');
//       } catch (error) {
...
//           variant="outlined"
//           fullWidth
//           value={title}  // Updated field name
//           onChange={(e) => setTitle(e.target.value)}  // Updated field name
...
// import { AppBar, Box, Toolbar, Typography, Button, TextField, Container, Card, CardContent, CardActions } from '@mui/material';
// import { styled } from '@mui/system';
// import axios from 'axios';
